...
return function(self, target)
	...
	return Serial {
		...
		While(
			function() return not self.earlyExitInfect end,
			Wait(3),
			Action()
		),
		...
		Do(function()
			...
			self.scene:run {
				...
				Do(function()
					self.doneWithInfect = true
				end)
			}
		end),
		
		YieldUntil(self, "doneWithInfect")
	}
end