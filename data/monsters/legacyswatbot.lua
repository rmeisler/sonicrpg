...
return {
	...
	behavior = function (self, target)
		...
		local targetList = {}
		for _, t in pairs(self.confused and self.scene.opponents or self.scene.party) do
			if t.state ~= BattleActor.STATE_DEAD then
		...
		return Serial {
			...
			laserShot(target),
			laserShot(targetList[math.random(#targetList)])
		}
	end
}