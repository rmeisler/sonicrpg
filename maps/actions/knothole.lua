return function(scene, hint)
	...
	then
		...
		return BlockPlayer {
			...
			MessageBox {message="Fleet: Princess{p60}, with all due respect{p60}, the Rebellion is an elite military force, combining undoubtedly the smartest and strongest minds in all of Mobius!"},
			...
			MessageBox {message="Fleet: Point is, {p20}while I'm sure you \"Freedom Fighters\" have fun playing your little games{p20}, maybe you should just let the grown ups take it from here..."},
			Do(function()
				fleet.sprite:setAnimation("meeting_laugh")
			end),
