return function(scene, hint)
	...
	return BlockPlayer {
		...
		Wait(0.5),
		Do(function()
			scene.objectLookup.Fleet2.sprite:setAnimation("fleetlaugh")
		end),
		MessageBox{message="Fleet: And once again, the Rebellion saved your Freedom Fighter butts."},
		...
		Animate(scene.objectLookup.Fleet2.sprite, "fleetsmile"),
		...
		MessageBox{message="Fleet: We were just--", closeAction=Wait(1)},
		Do(function()
			scene.objectLookup.Sonic.sprite:setAnimation("foottap")
		end),
		PlayAudio("music", "sonicupset", 1, true),
		MessageBox{message="Sonic: I don't wanna hear it!", closeAction=Wait(1)},
