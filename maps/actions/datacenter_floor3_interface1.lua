...
return function(self)
	...
	return Parallel {
		...
		Menu {
			layout = Layout {
				{Layout.Text("Shift Up"),
					choose = function(menu)
						menu:close()
						local lasers = {}
						if  self.scene.objectLookup.Laser1_3 and
							not self.scene.objectLookup.Laser1_1
						then
							lasers = {
								self.scene.objectLookup.Laser1_3,
								self.scene.objectLookup.Laser1_4
							}
						elseif  self.scene.objectLookup.Laser1_5 and
							not self.scene.objectLookup.Laser1_3
						then
							lasers = {
								self.scene.objectLookup.Laser1_5,
								self.scene.objectLookup.Laser1_6
							}
						else
