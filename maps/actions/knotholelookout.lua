return function(scene, hint)
	...
	if true then
		...
		return BlockPlayer {
			...
			MessageBox{message="Logan: I had to watch each of them get roboticized, one by one, until all that was left was just me and my mom."},
			...
			MessageBox{message="Logan: Some kinda empty platitude about how 'there's still hope' and 'we can do anything if we work together!'?"},
