...
return function(self)
	...
	return Parallel {
		...
		Menu {
			layout = Layout {
				{Layout.Text("Shift Down"),
					choose = function(menu)
						menu:close()
						local lasers = {}
						if  self.scene.objectLookup.Laser3_1 and
							not self.scene.objectLookup.Laser3_3
						then
							lasers = {
								self.scene.objectLookup.Laser3_1,
								self.scene.objectLookup.Laser3_2
							}
						elseif  self.scene.objectLookup.Laser3_3 and
							not self.scene.objectLookup.Laser3_5
						then
							lasers = {
								self.scene.objectLookup.Laser3_3,
								self.scene.objectLookup.Laser3_4
							}
						else
						...
						self.scene:run {
							...
							Do(function()
								lasers[1].y = lasers[1].y + 96
								lasers[2].y = lasers[2].y + 96
								...
								local newName1 = nameMapping[lasers[1].laserName]
								local newName2 = nameMapping[lasers[2].laserName]
